              ...
              {skills.map((skill, index) => (
                <>
                  <div className="skill_card p_relative bg_secondary color_white br_5">
                    <p key={index} className="flex jc-sb">
                      <span className="fw_900 fz_22">{skill.title}</span>{" "}
                      <span className="fw_900 fz_18 br_5 bg_color_green p_5">
                        {skill.percentage}
                      </span>
                    </p>
                    <div
                      className="skill_card_border"
                      style={skill.wid40}
                    ></div>
                  </div>
                </>
